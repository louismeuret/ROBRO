...
int main(void)
{
  ...
  MX_SPI1_Init();
  /* USER CODE BEGIN 2 */
  /* Gate-switching smoke test: same low duty on all 3 phases ->
   * identical voltages on U/V/W -> no current through windings.
   * Scope PA8 (UH), PA9 (VH), PA10 (WH) to see the PWM. */
